...
google-authenticator ([android](https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2), [ios](http://appstore.com/googleauthenticator)) on your phone or mobile device, or use a cross-platform app such as [Authy](https://authy.com/) which works on Windows, MacOS, Linux, Android and ios.
...
### <a id="2fac"></a> How to turn on 2-factor authentication on your machine account
...
2-Factor Authentication is now enabled.  
Each time you log in to the machine using this account, in additon to requesting your password and/or ssh key passphrase, you will also be asked for the current 6-digit authentication code from the app.

### How to turn off 2-Factor authentication on your machine account
